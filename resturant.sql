...
--
-- Host: localhost
-- Generation Time: Dec 24, 2019 at 01:08 AM
...
CREATE TABLE `categories` (
  ...
  `category_location_1` int(11) DEFAULT NULL,
  `category_location_2` int(11) DEFAULT NULL,
...
INSERT INTO `categories` (`category_id`, `category_name`, `category_location_1`, `category_location_2`, `time`) VALUES
(1, 'Best-Chinese', 18, 24, 'MON-FRI:10AM-12PM\r\nSAT-SUN:5PM-2PM'),
(2, 'Steak&SeaFood', 15, 83, 'MON-FRI:11AM-12PM\r\nSAT-SUN:6PM-2PM'),
(3, 'Ittalian-Pizza', 20, 9, '24 hours'),
(4, 'spanish-Food', 25, 17, 'MON-SUN:10AM-1AM\r\n'),
(5, 'Thai for YOU', 16, 9, 'MON-SUN:10AM-12PM'),
(6, 'Biriyani house(Indian)', 31, 31, 'MON-SUN:10AM-2AM'),
(7, 'Philliphiono', 37, 83, 'MON-FRI:10AM-12PM'),
(8, 'Macdonalds', 51, 35, 'MON-FRI:10AM-12PM'),
(9, 'Red-Robin Bakery', 39, 65, 'MON-FRI:10AM-12PM'),
(11, 'MMM', 44, 32, '7pm-11pm');
...
ALTER TABLE `categories`
  ...
  ADD UNIQUE KEY `category_location_1` (`category_location_1`,`category_location_2`);
...
--
ALTER TABLE `food_details`
  MODIFY `food_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
