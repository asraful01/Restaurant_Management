...
<a href="index.php">HOME |<a href="categories.php">Restaurants</a> | <a href="foods.php">Foods</a> |  <a href="logout.php">Logout</a>
</div>
<div id="container">
...
<tr>
    ...
    <td><input type="number" step=0.01 name="price" id="price" class="textfield" /></td>
